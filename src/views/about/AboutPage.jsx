      ...
      <main className="pallet-main" style={{ padding: '0 2rem' }}>
        ...
        <section className="about-section-grid">
           <div className="about-text">
              ...
              <p style={{ fontSize: '1.15rem', color: '#236516', lineHeight: '1.8' }}>
           ...
           <div 
             ...
             style={{ background: '#ffffff', height: '400px', borderRadius: '32px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}
           >
        ...
        <section className="connect-section" style={{ background: '#236516', borderRadius: '32px', padding: '4rem', color: '#ffffd5', textAlign: 'center', marginBottom: '4rem' }}>
           <h2 style={{ fontSize: '2rem', marginBottom: '1rem' }}>Stay Inspired</h2>
           <p style={{ color: '#98ae83', marginBottom: '2rem' }}>Join our newsletter for curated arrivals and exclusive brand stories.</p>
           <div style={{ display: 'flex', gap: '1rem', maxWidth: '500px', margin: '0 auto' }}>
              <input 
                type="email" 
                placeholder="Enter your email" 
                style={{ flex: 1, padding: '1rem 1.5rem', borderRadius: '12px', border: 'none', background: '#236516', color: '#ffffd5' }}
              />
              <button className="btn-primary" style={{ background: '#ffffff', color: '#236516' }}>Join</button>
           </div>
        </section>
      </main>
